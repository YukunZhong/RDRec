...
def main(
    ...
    input_json_path: str = '/home/wangjing/RDRec/data/beauty/explanation.json',
    output_json_path: str = '/home/wangjing/RDRec/data_qwen_distillation/beauty/explanation_rationale_test.json', #文件名稍作修改以示区别
